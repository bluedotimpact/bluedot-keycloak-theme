...
<@layout.registrationLayout
  displayMessage=!messagesPerField.existsError("password-new", "password-confirm")
  ;
  section
>
  <#if section="header">
  ...
  <#elseif section="form">
    <@form.kw action=url.loginAction method="post">
      ...
      <@input.kw
        ...
        required=false
        autofocus=true
        invalid=messagesPerField.existsError("password-new")
        label=msg("passwordNew")
        message=kcSanitize(messagesPerField.get("password-new"))
        name="password-new"
        type="password"
      />
      <@input.kw
